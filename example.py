...
f_ydot = lambdify((t, y, kf, kb), ydot)

k_vals = np.array([0.42, 0.17])  # arbitrary in this case
y0 = [1, 1, 0]  # initial condition (initial values)
times = np.linspace(0, 10, 50)  # evaluate integral from t = 0-10 for 50 points
...
solution = scipy.integrate.solve_ivp(f_ydot, (0, 10), y0, t_eval=times, args=k_vals)
